    <%@ page language="java" contentType="text/html; charset=UTF-8"
        ...
        <input type="hidden" name="flag" value="${flag }"/>
            ...
            <!--下面这个只是js中做判断 不会发送到controller 所以没有name-->
            <input type="hidden" id="menuLevel" value="${menuLevel }"/>
        ...
        <label>（<span style="color: red">*</span>例：log/logList）</label>
            ...
            <button class="layui-btn layui-btn-primary" >一级菜单（1-99），二级菜单（111-999），三级菜单（1111-9999）</button>

         <div class="layui-form-item">
        <label class="layui-form-label">排序</label>
        <div class="layui-input-block">
        <input type="text" name="sorting" class="layui-input" id="sorting"
